...
from .inputs import (
    ...
    KeyboardEventSource,
    LinuxThreeButtonEventSource,
    LinuxTwoButtonEventSource,
)
...
def collect(args) -> None:
    ...
    if args.three_button_config:
        sources.append(LinuxThreeButtonEventSource(args.three_button_config))
...
def parser() -> argparse.ArgumentParser:
    ...
    run.add_argument(
        "--three-button-config",
        help="three-key RECAP JSON mapping takeover/release/success",
    )
